...
public class Iterator {
    ...
    public Map<String, Object[]> iterate(Algo algo, String resource, String searchTerm, int maxThreads, boolean printLine) throws InterruptedException {
        ...
        Object[] allRunsData = new Object[runs.size()];
        for (int i = 0; i < runs.size(); i++) {
            ...
            allRunsData[i] = runData;
        }

        Map<String, Object[]> algoResult = new HashMap<>();
        algoResult.put(algo.getAlgoName(), allRunsData);
        return algoResult;
    }
}
